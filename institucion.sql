...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-10-2017 a las 21:28:36
...
CREATE TABLE `materia` (
  `id_materia` int(11) NOT NULL,
  `des_materia` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `persona` (
  ...
  `tel_persona` int(10) DEFAULT NULL,
  `cel_persona` int(10) NOT NULL,
...
(2, 'Ivan', 'Andres', 'Rodriguez', 'Pizza', '1141529810', 'Masculino', 'soltero', 'Cra 11D 54-93', 4387462, 313154251, 'ivanchos@gmail.com', 'qwerty', 1, 1);
...
--
ALTER TABLE `subactividad`
  MODIFY `id_subActividad` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `eva_x_act`
  ADD CONSTRAINT `eva_x_act_ibfk_1` FOREIGN KEY (`id_evaluacion`) REFERENCES `evaluacion` (`id_evaluacion`),
  ADD CONSTRAINT `eva_x_act_ibfk_2` FOREIGN KEY (`id_actividad`) REFERENCES `actividad` (`id_actividad`),
  ADD CONSTRAINT `eva_x_act_ibfk_3` FOREIGN KEY (`id_persona`) REFERENCES `persona` (`id_persona`),
  ADD CONSTRAINT `eva_x_act_ibfk_4` FOREIGN KEY (`id_materia`) REFERENCES `materia` (`id_materia`);
